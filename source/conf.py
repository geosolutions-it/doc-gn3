...
latex_documents = [('index', 'doc-gn3.tex', u'GN3 Documentation', u'ETj (GeoSolutions)', 'manual')]
...
man_pages = [('index', 'doc-gn3', u'GeoNetwork 3 Documentation', [u'ETj (GeoSolutions)'], 1)]
